...
This library works around a Hydrator Manager that has a configuration
of hydrators mapped to the classes they hydrate.  The hydrators are
individually composed classes thereby allowing any markup you desire, but the
recommendation is to stick to the HAL specification.
...
Resources.  The Resource object is the common object used to compose a HAL
...
is necessary that classes involved in HAL in Laravel extend from
abstract classes.
