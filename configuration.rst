...
Next, create your first hydrator
...
.. code:: php
  ...
  final class UserHydrator extends Hydrator
  {
      ...
      public function extract($class): Resource
      {
          ...
          // Extract model fields into an array to be used as the state
...
Before we can use this hydrator we may assign it to a model to hydrate from
...
The experienced Laravel developer will take one look at this and say, "Why
aren't you using a facade?"  And you're right.  It is recommended you use a
facade for your hydrator manager.  The rest of this documentation will assume
the use of a ``HALHydratorManager`` facade for the hydrator manager.
